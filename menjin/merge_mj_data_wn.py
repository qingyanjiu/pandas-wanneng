...
point_df = pd.read_excel('/home/coder/project/pandas/menjin/point.xlsx', sheet_name='门禁问题', usecols=lambda c: c != '升级情况' and c!= '问题' and c!= '楼层', skiprows=1)
...
device_df = pd.read_excel('/home/coder/project/pandas/menjin/device.xlsx', sheet_name=0, usecols=lambda c: c in (device_cols), skiprows=0)
...
channel_df = pd.read_json('/home/coder/project/pandas/menjin/channel.json', encoding='utf-8')
...
with open('mj_all.json', 'w', encoding='utf-8') as f:
    f.write(mapStr)
